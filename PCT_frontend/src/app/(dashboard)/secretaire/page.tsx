// ============================================================
// src/app/(dashboard)/secretaire/page.tsx
// ============================================================
"use client";
      ...
      <div className="grid lg:grid-cols-3 gap-4 mt-6">
        <Card className="lg:col-span-2 shadow-soft">
          <div className="p-5 border-b flex items-center justify-between">
            <div>
              <h3 className="font-display font-semibold">À valider en priorité</h3>
            ...
            {pending.map((p, i) => (
              <li key={i} className="p-4 flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-xs text-muted-foreground truncate">{p.c} • {p.h}h • {p.d}</div>
                </div>
        ...
        <Card className="p-6 shadow-soft">
          <h3 className="font-display font-semibold">Accès rapide</h3>
